  ...
  const steps: StepContent[] = [
    {
      ...
      keyTakeaway: "Polaris-EMS guarantees continuous life-support heating and electricity while minimizing diesel fuel use.",
    ...
    },
    {
      ...
      plainAnswer: "Polaris-EMS is an autonomous, intelligent mission control software designed specifically for polar microgrids. It acts like an autopilot for the station's energy system.",
      ...
      keyTakeaway: "A calm, sovereign mission control that ensures the lights and heaters never fail in Antarctica.",
    ...
    },
    {
      ...
      howItWorks: "It prioritizes renewable wind energy when available, preserves a 35% spinning reserve margin for emergencies, and ensures life-support systems (heaters, life-support) always have guaranteed power.",
      keyTakeaway: "Saves up to 18-25% in shipped-in diesel fuel while maintaining 100% life-support uptime.",
