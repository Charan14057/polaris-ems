# Polaris-EMS Model Card: polaris-load-xgb-maitri-v1.0

**SIH Problem Statement**: SIH26061 — AI-Driven Smart Energy Management System for Polar Research Stations  
**Model Name**: `polaris-load-xgb-maitri-v1.0`  
**Model Version**: `v1.0`  
**Station**: `MAITRI`  
...
- **sMAPE**: `7.23%`
- **R² Score**: `0.6894`
- **Mean Bias Error (MBE)**: `1.176 kW`

### Probabilistic Uncertainty & Empirical Coverage
- **Nominal 80% Interval Coverage**: `80.0%` (Gap: `+0.0%`)
- **Nominal 90% Interval Coverage**: `84.0%`
- **Mean 80% Interval Width (Sharpness)**: `21.81 kW`
