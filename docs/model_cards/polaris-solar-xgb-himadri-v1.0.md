# Polaris-EMS Model Card: polaris-solar-xgb-himadri-v1.0

**SIH Problem Statement**: SIH26061 — AI-Driven Smart Energy Management System for Polar Research Stations  
**Model Name**: `polaris-solar-xgb-himadri-v1.0`  
**Model Version**: `v1.0`  
**Station**: `HIMADRI`  
**Target Variable**: `solar_generation_kw`  
**Physical Rated Capacity**: `12.0 kW`  
**Git Commit**: `f81f4a3`  
...
- **sMAPE**: `25.32%`
- **R² Score**: `0.9382`
- **Mean Bias Error (MBE)**: `-0.0 kW`

### Probabilistic Uncertainty & Empirical Coverage
- **Nominal 80% Interval Coverage**: `98.2%` (Gap: `+18.2%`)
- **Nominal 90% Interval Coverage**: `98.6%`
- **Mean 80% Interval Width (Sharpness)**: `0.36 kW`
