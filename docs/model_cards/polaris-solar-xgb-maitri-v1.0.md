# Polaris-EMS Model Card: polaris-solar-xgb-maitri-v1.0

**SIH Problem Statement**: SIH26061 — AI-Driven Smart Energy Management System for Polar Research Stations  
**Model Name**: `polaris-solar-xgb-maitri-v1.0`  
**Model Version**: `v1.0`  
**Station**: `MAITRI`  
**Target Variable**: `solar_generation_kw`  
**Physical Rated Capacity**: `18.0 kW`  
**Git Commit**: `f81f4a3`  
...
- **sMAPE**: `41.14%`
- **R² Score**: `0.8765`
- **Mean Bias Error (MBE)**: `-0.005 kW`

### Probabilistic Uncertainty & Empirical Coverage
- **Nominal 80% Interval Coverage**: `85.8%` (Gap: `+5.8%`)
- **Nominal 90% Interval Coverage**: `90.1%`
- **Mean 80% Interval Width (Sharpness)**: `1.03 kW`
