# Polaris-EMS Model Card: polaris-wind-xgb-bharati-v1.0

**SIH Problem Statement**: SIH26061 — AI-Driven Smart Energy Management System for Polar Research Stations  
**Model Name**: `polaris-wind-xgb-bharati-v1.0`  
**Model Version**: `v1.0`  
**Station**: `BHARATI`  
**Target Variable**: `wind_generation_kw`  
**Physical Rated Capacity**: `25.0 kW`  
**Git Commit**: `f81f4a3`  
...
- **sMAPE**: `51.47%`
- **R² Score**: `0.33`
- **Mean Bias Error (MBE)**: `-0.251 kW`

### Probabilistic Uncertainty & Empirical Coverage
- **Nominal 80% Interval Coverage**: `83.4%` (Gap: `+3.4%`)
- **Nominal 90% Interval Coverage**: `90.1%`
- **Mean 80% Interval Width (Sharpness)**: `12.99 kW`
