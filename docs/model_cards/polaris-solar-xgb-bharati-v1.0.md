# Polaris-EMS Model Card: polaris-solar-xgb-bharati-v1.0

**SIH Problem Statement**: SIH26061 — AI-Driven Smart Energy Management System for Polar Research Stations  
**Model Name**: `polaris-solar-xgb-bharati-v1.0`  
**Model Version**: `v1.0`  
**Station**: `BHARATI`  
**Target Variable**: `solar_generation_kw`  
**Physical Rated Capacity**: `30.0 kW`  
**Git Commit**: `f81f4a3`  
...
- **Model Family**: Direct Astronomical XGBoost with Hard Night Clamping
...
- **sMAPE**: `36.0%`
- **R² Score**: `0.9013`
- **Mean Bias Error (MBE)**: `-0.082 kW`

### Probabilistic Uncertainty & Empirical Coverage
- **Nominal 80% Interval Coverage**: `85.9%` (Gap: `+5.9%`)
- **Nominal 90% Interval Coverage**: `91.2%`
- **Mean 80% Interval Width (Sharpness)**: `1.81 kW`
