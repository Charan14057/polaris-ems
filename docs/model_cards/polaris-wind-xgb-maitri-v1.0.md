# Polaris-EMS Model Card: polaris-wind-xgb-maitri-v1.0

**SIH Problem Statement**: SIH26061 — AI-Driven Smart Energy Management System for Polar Research Stations  
**Model Name**: `polaris-wind-xgb-maitri-v1.0`  
**Model Version**: `v1.0`  
**Station**: `MAITRI`  
**Target Variable**: `wind_generation_kw`  
**Physical Rated Capacity**: `15.0 kW`  
**Git Commit**: `f81f4a3`  
...
- **sMAPE**: `59.33%`
- **R² Score**: `0.2465`
- **Mean Bias Error (MBE)**: `-0.008 kW`

### Probabilistic Uncertainty & Empirical Coverage
- **Nominal 80% Interval Coverage**: `81.3%` (Gap: `+1.3%`)
- **Nominal 90% Interval Coverage**: `88.3%`
- **Mean 80% Interval Width (Sharpness)**: `6.85 kW`
